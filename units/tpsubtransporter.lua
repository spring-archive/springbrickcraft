unitDef = {
  unitname            = "tpsubtransporter",
  name                = "Underground Transport Vehicle",
  description         = "carries up to 6 dudes and can move underground",
  acceleration        = 0.1,
  bmcode              = [[1]],
  brakeRate           = 0.2,
  buildCostEnergy     = 0,
  ...
  TransportCapacity = 6,    --The number of units the transport can carry
  transportSize = 6,
  TransportMass = 24*6,
...
return lowerkeys({ tpsubtransporter = unitDef })