...
function script.HitByWeapon (x, z, weaponDefID, damage)	
	...
	if weaponDefID ~= drill then damage= 0 end --and weaponDefID~= -2 HÄ=-2 was used in gadget AddUnitDamage (...weapondefid=-2)
	if weaponDefID == -5 then return 0 end	--no water damage
	if weaponDefID == -1 then return 0 end --debris
Spring.Echo ("angesammelt!" .. damage )
