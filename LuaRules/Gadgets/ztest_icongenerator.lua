--[[
[18:54:57] <[2up]knorke> i must tweak a bit..some icons come out like http://www.abload.de/img/tpheavytanka6jx6.png
[18:55:12] <[2up]knorke> but should be http://www.abload.de/img/tpheavytankblueaykpc.png (the threads)
[18:56:46] <[LCC]jK> just add:
[18:56:59] <[LCC]jK>   [UnitDefNames.foobar.id] = {
[18:56:59] <[LCC]jK>     unfold = true,
[18:56:59] <[LCC]jK>   },
[18:57:03] <[LCC]jK> in that case
  ...
  function gadget:RecvLuaMsg(msg, playerID)
    if (msg:find("buildicon",1,true)) then
      if (not Spring.IsCheatingEnabled()) then
		...
		Spring.Echo ("CHEATING MUST BE ENABLED ECHO LOL")
        return true;
      end;
