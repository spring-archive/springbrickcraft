		...
		if cy < 25 or cy > 4000 then
			...
			if unitIDList[1] == nil then
				...
				for _,unitID in ipairs(unitIDList) do
					...
					if alpha <= 1 and alpha>0 then --knorke: added the alpha <= 1 so subterrain units get no shadow
